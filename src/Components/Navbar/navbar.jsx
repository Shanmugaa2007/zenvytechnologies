...
import logo from '/src/assets/Zenvylogo.png'
    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <ul className={active ? "nav-links" : "linkss"}>
          <li><a className='navigate' href='/'>Home</a></li>
          ...
          {/* <li><Link className='navigate' onClick={clicked} to="/internship">Internships</Link></li> */}
