...
import intern_certificate from './assets/demoCertificate.png';
    ...
    return(
        <>
            ...
            <div className="learn-offer">
                <h1><i className="fa-solid fa-envelope"></i> Internship Offer Letter</h1>
            ...
            <div className="learn-offer">
                <h1><i className="fa-solid fa-gear"></i> Technical Training</h1>
            ...
            <div className="learn-offer">
                <h1><i className="fa-solid fa-medal"></i> Training Certificate</h1>
            ...
            <div className="learn-offer">
                <h1><i className="fa-solid fa-laptop-code"></i> Two Mini Projects</h1>
            ...
            <div className="learn-offer">
                <h1><i className="fa-solid fa-folder-open"></i> One Major Project</h1>
            ...
            <div className="learn-offer">
                <h1><i className="fa-solid fa-newspaper"></i> Internship Certificate</h1>
