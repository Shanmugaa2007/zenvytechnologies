    ...
    <>
      <div className="role-container" id="scrollRoot">
        ...
        <div className="select-wrapper">
          ...
          >
            <option defaultValue="1m"selected>Select Duration</option>
        ...
        <div className="intern-lists" id="internlistss">
          {filterlist.length > 0 ? (
            filterlist.map((list) => (
              <div className="intern-grids" key={list._id}>
                ...
                <div className="final-intern">
                  ...
                  <Link to="/applynow" className="apply" state={{
                    ...list,
                    updatedPrice: getUpdatedPrice(list.price),
                    selectedDuration: getDurationLabel()
                  }}>Apply Now</Link>
